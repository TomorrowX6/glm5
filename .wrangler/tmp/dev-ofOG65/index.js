...
// .wrangler/tmp/bundle-uz7rIQ/checked-fetch.js
...
// .wrangler/tmp/bundle-uz7rIQ/strip-cf-connecting-ip-header.js
...
${m.content || ""}`
    ...
    if (m.role === "assistant" && Array.isArray(m.tool_calls) && m.tool_calls.length > 0) {
      const toolDesc = m.tool_calls.map((tc) => {
        const name = tc.function?.name || tc.name || "";
        const args = tc.function?.arguments || tc.arguments || "";
        const id = tc.id || "";
        return `\u6211\u5DF2\u8C03\u7528\u5DE5\u5177 ${name}${id ? ` (\u8C03\u7528ID: ${id})` : ""}\uFF0C\u53C2\u6570\uFF1A${args}`;
      }).join("\n");
...
// .wrangler/tmp/bundle-uz7rIQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uz7rIQ/middleware-loader.entry.ts
